...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.NewsViewHolder> {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i) {
                            case 0:
                                ...
                                break;
                            case 1:
                                new AlertDialog.Builder(context).setTitle(R.string.delete_notify).setPositiveButton(R.string.ok_button,
    ...
    private class delete_post extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            return request.send_request(public_value.host, "{\"post_id\":" + args[0] + ",\"encode\":\"" + request.getMD5(args[0] + args[1] + public_value.password) + "\"}", "delete");
        }
